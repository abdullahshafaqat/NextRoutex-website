...
function StarIcon() {
  return (
    <svg className="h-4 w-4 fill-[#e63946] text-[#e63946]" viewBox="0 0 20 20">
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="relative flex justify-center lg:justify-start">
            <div className="relative">
              <div className="absolute -right-4 -top-4 h-32 w-32 rounded-full bg-[#e63946]" />
              ...
              <div className="absolute -right-2 top-8">
                <svg className="h-12 w-12 text-[#e63946]" viewBox="0 0 50 50" fill="currentColor">
